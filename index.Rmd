...
information systems. At the end of the workshop, the participants will have a basic understanding of R and geographical information systems. For this workshop we will be using a data set derived from a bovine rabies study done in the south of Mexico in 2016 provided by Alejandro Zaldivar Gomez et. al.  
...
At the end of this workshop you will be able to use your own R to process your data and generate visualizations such as these:
...
```{r}
data.frame(
  Time = c('10:00-11:00', '11:00-11:45', '11:45-12:00', '12:00-13:00', '13:00-14:00', '14:00-15:00', '15:00-16:00'),
  D01 = c('Introduction to R', 'Intro to R studio and Markdown',  'Break', 'R syntax and the tidyverse', 'Lunch', 'Graphics in R I', 'Graphics in R II'),
  # D01 = cell_spec(c('Introduction to R', 'Intro to R studio and Markdown', 'R syntax and the tidyverse', 'Lunch', 'Graphics in R I', 'Graphics in R II'), 'html', link = c('', '1a_Intro_RstudioMarkdown.html', '1b_RandTidyverse.html','Lunch.html', '1c_GraphicsI.html', '1d_GraphicsII.html')),
  D02 = c('Geographical Information systems', 'Intro to vectors and rasters', 'Break', 'Manipulating spatial objects and projections', 'Lunch', 'Spatial statistics', 'Cartography'),
  D03 = c('Network Analysis','Intro to SNA', 'Break', 'Network visualization', 'Lunch', 'Bipartite Networks', 'Dynamic Networks'),
  D04 = c('Risk assessment', 'Introduction to Risk assessment', 'Break', 'Risk assessment in R I', 'Lunch', 'Risk assessment in R I II', '')
) %>% 
  ...
  row_spec(c(3,5), background = "#F6F5FA", italic = T)
```

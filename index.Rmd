...
data.frame(
  ...
  D02 = cell_spec(
    c('Geographical Information systems','R syntax and the tidyverse', 'Graphics in R', 'Break', 'Graphics in R (cont.)', 'Lunch', 'Vectors and rasters', 'Cartography', ''), 'html',
    link = c('slides/2a_Viz.html', '1b_RandTidyverse.html', '1c_GraphicsI.html', '', '1c_GraphicsI.html', 'Lunch.html', '2a_VectorsRasters.html', '', '')
  ),
...
-   [Desktop installation instructions](https://www.spablo-temporal.network/ShinyWorkshop/0a_R_Intro.html)

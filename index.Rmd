...
# Objectives
  ...
  - Integrate geospatial data in our analysis and visualization.
...
Please follow [these instructions](0a_R_Intro.html) for software installation and make sure you have R version \>3.5
...
-   [Shared
    folder](https://ucdavis.box.com/s/65bg7mu85kblruofbkf481ontvuw128e), we will use this folder to provide some workshop materials such as code, data, or other resources.

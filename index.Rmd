...
data.frame(
  ...
  D02 = cell_spec(
    c('Geographical Information systems','R syntax and the tidyverse', 'Graphics in R', 'Break', 'Vectors and rasters', 'Lunch', 'Manipulating spatial objects', 'Cartography', ''), 'html',
    link = c('', '1b_RandTidyverse.html', '1c_GraphicsI.html', '', '', '', '', '', '')
  ),

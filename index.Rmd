...
#   D01 = c('Introduction to R', '', '', '', 'Intro to R studio and Markdown', 'Lunch', 'R syntax and the tidyverse', 'Graphics in R I', 'Graphics in R II'),
#   # D01 = cell_spec(
#   #   c('Introduction to R', '', '', '', 'Intro to R studio and Markdown', 'Lunch', 'R syntax and the tidyverse', 'Graphics in R I', 'Graphics in R II'), 'html', 
#   #   link = c('', '', '', '', '1a_Intro_RstudioMarkdown.html', 'Lunch.html', '1b_RandTidyverse.html', '1c_GraphicsI.html', '1d_GraphicsII.html')
#   # ),
...
#   # D02 = cell_spec(
#   #   c('Geographical Information systems','Introduction to geographical information systems', 'Vectors and rasters', 'Break', 'Manipulating spatial objects and projections', 'Lunch', 'Spatial statistics', 'Cartography', ''), 'html', 
#   #   link = c('', '', '', '', '', '', '', '', '')
#   # ),
#   D03 = c('Network Analysis','Intro to SNA', 'SNA in R', 'Break', 'Network visualization', 'Lunch', 'Bipartite Networks', 'Dynamic Networks', ''),
#   # D03 = cell_spec(
#   #   c('Network Analysis','Intro to SNA', 'SNA in R', 'Break', 'Network visualization', 'Lunch', 'Bipartite Networks', 'Dynamic Networks', ''),
#   #   'html',
#   #   link = c('', '', '3a_NetworkViz.html', '', '3a_NetworkViz.html', 'Lunch.html', '', '3c_DynamicNetworks.html', '')
#   # ),
#   D04 = c('Risk assessment', 'Case studies', 'Introduction to Risk assessment', 'Break', 'Risk assessment in R I', 'Lunch', 'Risk assessment in R I II', '', '')
#   # D04 = cell_spec(
#   #   c('Risk assessment', 'Case studies', 'Introduction to Risk assessment', 'Break', 'Risk assessment in R I', 'Lunch', 'Risk assessment in R I II', '', ''),
#   #   'html',
#   #   link = c('4a_RiskAssessment.html', '', '', '', '', '', '', '', '')
#   # )
# ) %>% 
...
data.frame(
  ...
  D01 = cell_spec(
    ...
    link = c('', '1a_Intro_RstudioMarkdown.html', '1b_RandTidyverse.html', '', '1c_GraphicsI.html', 'Lunch.html', '2a_VectorsRasters.html', '', '')
  ),
  D02 = cell_spec(

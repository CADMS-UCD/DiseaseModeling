...
data.frame(
  ...
  D01 = c('Introduction to R', 'Intro to R studio and Markdown', 'R syntax and the tidyverse', 'Lunch', 'Graphics in R', ''),
  # D01 = cell_spec(c('Intro to R studio', 'R syntax', 'Lunch', 'Graphs', ''), 'html', link = c('')),
  ...
  D04 = c('Advanced visualization', 'Interactive visualization', 'Implementation of dashboards', 'Lunch', '', '')
) %>% 
  kbl("html", escape = FALSE, col.names = c('Time', 'Day 01', 'Day 02', 'Day 03', 'Day 04')) %>%

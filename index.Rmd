...
data.frame(
  ...
  D01 = cell_spec(c('Introduction to R', 'Intro to R studio and Markdown', 'R syntax and the tidyverse', 'Lunch', 'Graphics in R I', 'Graphics in R II'), 'html', link = c('', '1a_Intro_RstudioMarkdown.html', '1b_RandTidyverse.html','', '1c_GraphicsI.html', '')),

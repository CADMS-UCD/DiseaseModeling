...
We can also add other additional legends like a north arrow, we will add one with the function `annotation_north_arrow()` from the `ggspatial` library:

```{r}
Maps$area <- Maps$area + # use the previously created map
